# -*- coding: utf-8 -*-
"""Data classes and functions related to the registry configuration.

A registry can optionally be managed with a configuration file.
"""
...
@dataclass
class Config:
    """The overall registry configuration."""
...
def _check_api_version(api_version):
    ...
    if api_version is None:
        ...
        raise RuntimeError(
            f"The config api_version ({api_version}) is not supported by this version of the registry. Consider upgrading."
        )
